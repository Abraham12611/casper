...
const PHASE_LABELS = {
  scrape_content: "Preparing Research",
  generate_dossier: "Building Lead Profiles",
} as const;
...
const AUDIT_PHASE_LABELS = {
  map_urls: "Scanning Website",
  filter_urls: "Filtering URLs",
  scrape_content: "Extracting Data",
  generate_dossier: "Analyzing Pain Points",
} as const;
      ...
      <div className="max-w-6xl mx-auto w-full space-y-6">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p>Research progress: {phaseProgress}% complete</p>
                                </TooltipContent>
                              </Tooltip>
                            </TooltipProvider>
                          </div>
        ...
        {demoCallModalOpen && demoCallOpportunityId && agencyProfile && (
          <DemoCallModal
            ...
            agencyId={agencyProfile.agencyProfileId}
            casperCreditsBalance={casperCreditsBalance}
