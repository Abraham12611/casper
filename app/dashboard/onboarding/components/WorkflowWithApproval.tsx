        ...
        >
            ...
            <div className="flex flex-col md:flex-row items-start justify-between gap-8 mb-10">
                <div className="space-y-3">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[12px] font-mono font-bold text-[#3b82f6] uppercase tracking-[0.2em]">Website Research Protocol</span>
                    </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-2 mb-2 px-2">
                    ...
                    <span className="text-[10px] font-mono font-bold text-[#52525e] uppercase tracking-[0.2em]">Research Activity</span>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
                <div className="flex items-center gap-3 mb-8 px-2">
                    ...
                    <h2 className="text-[14px] font-mono font-bold text-[#f0f0f5] uppercase tracking-[0.2em]">Research Timeline</h2>
                </div>
