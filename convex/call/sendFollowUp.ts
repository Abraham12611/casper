...
Meeting arranged through Casper AI call.
...
async function sendProspectEmail(
  ...
  const emailId = await ctx.runMutation(internal.call.emailMutations.createQueuedEmail, {
    ...
    agencyId: agency._id,
    from: "Casper <notifications@scheduler.atlasoutbound.app>",
    to: prospectEmail,
...
async function sendAgencyEmail(
  ...
  const emailHTML = `
    ...
    <p>This meeting was automatically booked through Casper AI calling system.</p>
  `;
